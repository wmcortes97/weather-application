...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/utils/getDate.js":[function(require,module,exports) {
"use strict";
...
function getTime() {
  ...
  if (hour === 12) {
    time = "".concat(hour, ":").concat(minutes, " PM");
  } else if (hour > 13) {
    time = "".concat(hour - 12, ":").concat(minutes, " PM");
  } else {
    time = "".concat(hour, ":").concat(minutes, " AM");
  }
  return time;
}
},{}],"src/utils/weatherIconDisplayed.js":[function(require,module,exports) {
"use strict";
...
function setImgSrc(temp) {
  var imgElement = document.getElementById("weather-icon");
  if (temp === "Clear") {
...
var _weatherIconDisplayed = require("./utils/weatherIconDisplayed");
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
//displaying date and time
var dateDisplayed = document.querySelector("#date-today");
dateDisplayed.innerHTML = "".concat((0, _getDate.getDate)(), " ").concat((0, _getTime.getTime)());

//temperture converter
var tempDisplayed = document.querySelector(".temperature");
var tempInteger = parseInt(tempDisplayed.textContent);
var fahrenheit = document.querySelector(".fahrenheit");
fahrenheit.addEventListener("click", function (e) {
  var conversion = [tempInteger * (9 / 5)] + 32;
  tempDisplayed.innerHTML = conversion;
});
var celsius = document.querySelector(".celsius");
celsius.addEventListener("click", function (e) {
  var conversion = (tempInteger - 32) * (5 / 9);
  tempDisplayed.innerHTML = conversion;
});

//displaying temperture data
var apiKey = "e158e30a8e642685a11d3f2e3848c46d";
var cityInput = document.querySelector("#city-input");
var form = document.querySelector("form");
var cityDisplayed = document.querySelector("#city-displayed");
var windDisplayed = document.getElementById("wind");
...
form.addEventListener("submit", function (e) {
  e.preventDefault();
  var apiUrl = "https://api.openweathermap.org/data/2.5/weather?q=".concat(cityInput.value, "&units=imperial&appid=").concat(apiKey);
  _axios.default.get(apiUrl).then(function (response) {
    ...
    (0, _weatherIconDisplayed.setImgSrc)(response.data.weather[0].main);
...
},{"./utils/getDate":"src/utils/getDate.js","./utils/getTime":"src/utils/getTime.js","./utils/weatherIconDisplayed":"src/utils/weatherIconDisplayed.js","axios":"node_modules/axios/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
